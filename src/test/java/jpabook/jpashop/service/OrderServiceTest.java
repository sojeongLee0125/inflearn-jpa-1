...
class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Assertions.assertEquals(OrderStatus.ORDER, getOrder.getStatus(), "상품 주문 상태 ORDER");
        ...
        Assertions.assertEquals(8, book.getStockQuantity(), "주문수량만큼 재고가 줄어야한다.");
    }
    ...
    public void 주문취소() throws Exception {
        ...
        assertEquals(10, item.getStockQuantity(), "주문이 취소된 상품은 재고가 원복");
    }
